        ...
        <section className="landing" id="game">
          <div className="landing-copy">
            ...
            <fieldset className="difficulty-picker"><legend>{t('difficulty')}</legend>
              <button className={state.difficulty === 'beginner' ? 'selected' : ''} onClick={() => setDifficulty('beginner')}><strong>{t('beginner')}</strong><small>Draw · Learn</small></button>
              <button className={state.difficulty === 'tactical' ? 'selected' : ''} onClick={() => setDifficulty('tactical')}><strong>{t('tactical')}</strong><small>Hit · Block · Promote</small></button>
            </fieldset>
